...
const CustomKeyboard = ({ onKeyPress, onDelete, onClear, onSubmit, onClose, inputValue, onNext, label }) => {
    ...
    const handleClose = () => {
        ...
        if (onClose) {
            onClose(); // Ensure the passed onClose function is called
        }
    };
    ...
    return (
        <View style={keyboardStyles.keyboardWrapper}>
            ...
            <View style={[keyboardStyles.keyboardContainer, keyboardStyles.greyBorderTop]}>
                <View>
                    <CustomText>{isKeyboardVisible ? "vis" : "inVis"}</CustomText>
                ...
                <View style={styles.row}>
                    ...
                    <View style={styles.marginLeft}>
                        ...
                        <Pressable style={[keyboardStyles.key, keyboardStyles.greyBorder, keyboardStyles.closeKey]} onPress={handleClose}>
